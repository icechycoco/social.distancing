...
var ReactPageScroller = function ReactPageScroller(_ref) {
  ...
  var setRenderComponents = (0, _react.useCallback)(function () {
    ...
    while (i < componentsToRenderLength && !(0, _lodash.isNil)(children[i])) {
      ...
      newComponentsToRender.push(_react2.default.createElement(
        ...
        _react2.default.cloneElement(children[i], _extends({}, children[i].props))
      ));
      i++;
    }
  ...
  (0, _react.useEffect)(function () {
    if (!(0, _lodash.isNil)(customPageNumber) && !(0, _lodash.isEqual)(customPageNumber, componentIndex)) {
      var newComponentsToRenderLength = componentsToRenderLength;

      if (!(0, _lodash.isEqual)(componentIndex, customPageNumber)) {
        if (!(0, _lodash.isNil)(containers[customPageNumber]) && !isScrolling) {
          isScrolling = true;
          // eslint-disable-next-line max-len
          pageContainer.current.style.transform = "translate3d(0, " + customPageNumber * -100 + "%, 0)";

          if ((0, _lodash.isNil)(containers[customPageNumber]) && !(0, _lodash.isNil)(children[customPageNumber])) {
        ...
        } else if (!isScrolling && !(0, _lodash.isNil)(children[customPageNumber])) {
